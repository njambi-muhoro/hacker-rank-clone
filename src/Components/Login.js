...
function Login() {
  ...
  function handleLogin(e) {
	...
	return (
		<div>
			<section className='gradient-form h-full bg-neutral-200 dark:bg-neutral-700 mt-10'>
										...
										<div className='md:mx-6 md:p-12'>
											...
											<div className='text-center'>
												<img
													...
													alt='logo'
												/>
												<h4 className='mb-12 mt-1 pb-1 text-sm font-semibold'>
            ...
            <!-- Right column container with background and description--> */}
									<div className=' bg-green-500 flex items-center rounded-b-lg lg:w-6/12 '>
										<div className=' bg-green-500 px-4 py-6 md:mx-12 md:p-12 '>
