 ...
 const handleSubmit = (event) => {
  ...
  return (
    ...
    <div>
      ...
      {/* <div className="mt-9 lg:max-w-6xl mx-auto w-full sm:px-6 lg:px-8 h-[100vh] justify-center items-right">
     
     <button className="font-bold px-9 text-center bg-green-700" onClick={() => setModalIsOpen(true)} >
       <GoPlus />Invite now
     </button>
     <Modal
       isOpen={modalIsOpen}
