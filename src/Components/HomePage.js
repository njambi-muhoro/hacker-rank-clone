...
function HomePage(){
    ...
    <div className="mt-[10vh] mb-[10vh]">
        <div className="bg-[#EAF3F9] p-6">
            <div className="lg:w-7xl">
                <div className="text-center font-bold font-serif text-6xl">
        ...
        <div className="bg-[#FBFBFF] p-10 mt-10">
            <div className="lg:w-7xl">
                ...
                <div className="bg-black p-4 lg:p-6 max-w-screen-lg mx-auto grid grid-cols-2 gap-8 rounded-lg mt-10">
    ...
    <div className="lg:w-7xl">
            ...
            <div className="text-xm flex justify-center mt-10">
        ...
        <div class="flex items-center justify-center mt-10">
                <img src="https://marketinghr.wpengine.com/wp-content/uploads/2022/10/tool1.png" alt="Tool 1" class="mx-4" />
                <img src="https://marketinghr.wpengine.com/wp-content/uploads/2022/10/tool2.png" alt="Tool 2" class="mx-4"/>
                <img src="https://marketinghr.wpengine.com/wp-content/uploads/2022/10/tool3.png" alt="Tool 3" class="mx-4"/>
                <img src="https://marketinghr.wpengine.com/wp-content/uploads/2022/10/tool4.png" alt="Tool 4" class="mx-4"/>
                <img src="https://marketinghr.wpengine.com/wp-content/uploads/2022/10/tool5.png" alt="Tool 5" class="mx-4"/>
                <img src="https://marketinghr.wpengine.com/wp-content/uploads/2022/10/tool6.png" alt="Tool 6" class="mx-4"/>
                <img src="https://marketinghr.wpengine.com/wp-content/uploads/2022/10/tool7.png" alt="Tool 7" class="mx-4"/>
        </div>
        <div className="mt-10 p-4 lg:p-6 max-w-screen-lg mx-auto"><img src="https://www.hackerrank.com/wp-content/uploads/2022/11/interview1.png" alt=""/>
        </div>
 
        <div class="flex justify-center p-10">
            <div class="w-full max-w-screen-lg grid grid-cols-2 gap-8">
                <div class="rounded-lg p-6">
                    <h3 class="text-2xl font-bold mb-4">Practice coding challenges &amp; <span class="text-[#008000]">prep for interviews</span></h3>
                    <p class="text-lg mb-6">Start practicing your skills now and land the job of your dreams.</p>
                ...
                <div class="bg-[#EAF3F9] rounded-lg p-6">
                    <h3 class="text-2xl font-bold mb-4">Get started <span class="text-[#008000]">hiring with HackerRank</span></h3>
                    <p class="text-lg mb-6">More than 3,000 tech teams, representing all industries and from countries around the world, trust HackerRank</p>
